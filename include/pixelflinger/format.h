...
enum GGLPixelFormat {
    ...
    GGL_PIXEL_FORMAT_YCbCr_422_SP       = 0x10,     // NV16
    GGL_PIXEL_FORMAT_YCrCb_420_SP       = 0x11,     // NV21 (_adreno)
    GGL_PIXEL_FORMAT_YCbCr_422_P        = 0x12,     // IYUV
    GGL_PIXEL_FORMAT_YCbCr_420_P        = 0x13,     // YUV9
    GGL_PIXEL_FORMAT_YCbCr_422_I        = 0x14,     // YUY2 (_adreno)
    GGL_PIXEL_FORMAT_YCbCr_420_I        = 0x15,
    GGL_PIXEL_FORMAT_CbYCrY_422_I       = 0x16,     // UYVY (_adreno)
    GGL_PIXEL_FORMAT_CbYCrY_420_I       = 0x17,
    GGL_PIXEL_FORMAT_YCbCr_420_SP_TILED = 0x20,     // NV12_adreno_tiled
    GGL_PIXEL_FORMAT_YCbCr_420_SP       = 0x21,     // NV12
    GGL_PIXEL_FORMAT_YCrCb_420_SP_TILED = 0x22,     // NV21_adreno_tiled
    GGL_PIXEL_FORMAT_YCrCb_422_SP       = 0x23,     // NV61
    GGL_PIXEL_FORMAT_YCrCb_422_P        = 0x24,     // YV12 (_adreno)
