...
static struct perms_ devperms[] = {
    ...
    { "/dev/diag",          0660,   AID_ROOT,       AID_DIAG,       1 },
    ...
    { "/dev/radio0",        0666,   AID_SYSTEM,     AID_AUDIO,         1 },
#endif
    ...
    { "/dev/system_bus_freq", 0666, AID_ROOT,       AID_ROOT,       0 },
    { "/dev/cpu_dma_latency", 0666, AID_ROOT,       AID_ROOT,       0 },
    { NULL, 0, 0, 0, 0 },
};
